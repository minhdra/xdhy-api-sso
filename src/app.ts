...
app.use('/api-sso/uploads/app-icons', express.static('uploads/app-icons', { maxAge: '1y', immutable: true }));
app.use('/api-sso/uploads/avatars', express.static('uploads/avatars', { maxAge: '1y', immutable: true }));
